...
export default async function Home() {
  ...
  return (
    <main className="min-h-screen bg-[#1C1B1F] relative">
      <Navbar />
      ...
      <a
        href="https://github.com/loyaltly-cn/nextjs-boilerplate"
        target="_blank"
        rel="noopener noreferrer"
        className="fixed bottom-8 left-8 flex items-center space-x-2 text-[#E6E1E5] hover:text-[#D0BCFF] transition-colors duration-200"
      >
